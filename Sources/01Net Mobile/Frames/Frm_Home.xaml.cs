...
//*******************************************************************************************************************************
// Début du bloc "NextRadio.Frames"
//*******************************************************************************************************************************
namespace NextRadio.Frames
	...
	public partial class Frm_Home : PhoneApplicationPage, IPhoneApplicationPage
		...
		private void SetTitle ( SectionType Section )
			...
			switch ( Section )
				...
				//---------------------------------------------------------------------------------------------------------------
				case SectionType.Apps       : this.Section.Text = "APPLIS, LOGICIELS";  break;
				case SectionType.Culture    : this.Section.Text = "CULTURE, MÉDIAS";    break;
				case SectionType.Games      : this.Section.Text = "JEUX";               break;
				case SectionType.Politics   : this.Section.Text = "POLITIQUE, DROITS";  break;
				case SectionType.Products   : this.Section.Text = "PRODUITS";           break;
				case SectionType.Rugby      : this.Section.Text = "RUGBY";              break;
				case SectionType.Security   : this.Section.Text = "SÉCURITÉ";           break;
				case SectionType.Science    : this.Section.Text = "SCIENCE, RECHERCHE"; break;
				case SectionType.Society    : this.Section.Text = "BUZZ, SOCIÉTÉ";      break;
				case SectionType.Technology : this.Section.Text = "TECHNOLOGIES";       break;
				case SectionType.Telecoms   : this.Section.Text = "TÉLÉCOMS";           break;
				case SectionType.Tv         : this.Section.Text = "01NET TV";           break;
				//---------------------------------------------------------------------------------------------------------------
				}
			//-------------------------------------------------------------------------------------------------------------------
			}
				...
				if ( this.NavigationContext != null && this.NavigationContext.QueryString != null 
					...
					if ( this.NavigationContext.QueryString.ContainsKey ( "Section" ) )
						...
						switch ( this.NavigationContext.QueryString["Section"] )
							{
							case "Apps"       : CurrentSection = SectionType.Apps;       break;
							case "Bookmarks"  : CurrentSection = SectionType.Bookmarks;  break;
							case "Culture"    : CurrentSection = SectionType.Culture;    break;
							case "Games"      : CurrentSection = SectionType.Games;      break;
							case "Politics"   : CurrentSection = SectionType.Politics;   break;
							case "Products"   : CurrentSection = SectionType.Products;   break;
							case "Rugby"      : CurrentSection = SectionType.Rugby;      break;
							case "Security"   : CurrentSection = SectionType.Security;   break;
							case "Science"    : CurrentSection = SectionType.Science;    break;
							case "Society"    : CurrentSection = SectionType.Society;    break;
							case "Technology" : CurrentSection = SectionType.Technology; break;
							case "Telecoms"   : CurrentSection = SectionType.Telecoms;   break;
							case "Tv"         : CurrentSection = SectionType.Tv;         break;
							}
		...
		// Description : Lance une navigation
		//***********************************************************************************************************************
		/// <summary>
		/// Lance une navigation.
		/// </summary>
		...
		private void WebBrowser_LoadCompleted ( object Sender, NavigationEventArgs Args )
			...
			if ( this.WebBrowserCache.Visibility == Visibility.Visible )
				{
				//---------------------------------------------------------------------------------------------------------------
				this.Dispatcher.Async ( () => { this.WebBrowserCache.Visibility = Visibility.Collapsed; } );
				//---------------------------------------------------------------------------------------------------------------
				}
			//-------------------------------------------------------------------------------------------------------------------
			}
		...
		private void OnShareButtonClick ( object Sender, EventArgs Args )
			...
			if ( Item != null )
				...
				if ( string.IsNullOrEmpty ( Title ) )
					Title = string.Format ( "Article n°{0} - 01net.com", Item.ArticleID );
				//---------------------------------------------------------------------------------------------------------------
	...
	} // Fin du namespace "NextRadio.Frames"
//*******************************************************************************************************************************
