...
namespace System.Windows.Phone.Gestures
	...
	public class GestureHelper
		...
		private class ManipulationBaseArgs : InputBaseArgs
			{
			//*******************************************************************************************************************
			public ManipulationBaseArgs ( UIElement Container, Point Origin ) 
			                                                        : base ( Container, Origin ) {}
			//*******************************************************************************************************************
			}
		//-----------------------------------------------------------------------------------------------------------------------
		#endregion
		...
		private class ManiulationCompletedArgs : InputCompletedArgs
			...
			//*******************************************************************************************************************
			public ManiulationCompletedArgs ( UIElement Container, Point Origin, Point Total ) 
			                                                           : base ( Container, Origin )
				{ this.Total = Total; }
			//*******************************************************************************************************************
		...
		private static double AngleFromVector ( double X, double Y )
			...
			if ( Value < 0.0 ) Value = ( Math.PI * 2.0 ) + Value;

			return ( ( Value * 360.0 ) /  ( Math.PI * 2.0 ) );
			//-------------------------------------------------------------------------------------------------------------------
			}
		//***********************************************************************************************************************
