		...
		private void OnDrag ( PhoneOrientation Orientation, System.Windows.Phone.Gestures.DragEventArgs Args )
			...
			if ( ! this.Dragging )
				...
				if ( this.FSelectedPanel == SlidePanel.Center )
					...
					this.LeftToRightDragging = ( this.LeftContent  != null && DeltaDistanceX > 0 && Origin < LDistanceToOpen );
					this.RightToLeftDragging = ( this.RightContent != null && DeltaDistanceX < 0 && Origin > RDistanceToOpen );
