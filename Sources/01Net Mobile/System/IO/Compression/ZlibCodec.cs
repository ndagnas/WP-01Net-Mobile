...
// Description   : Implémentation de l'objet ZlibCodec
    ...
    internal sealed class ZlibCodec
    {
        ...
        internal void flush_pending()
        {
            ...
            if (pendingCount != 0)
            {
                ...
                {
                    throw new ZlibException(string.Format("Invalid State. (pending.Length={0}, pendingCount={1})", new object[] { this.dstate.pending.Length, this.dstate.pendingCount }));
                }
