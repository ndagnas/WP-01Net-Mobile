...
namespace System.IO
	...
	public class AppBookmarks : IDisposable
		...
		class BookmarksComparer : IComparer<KeyValuePair<object, DateTime>>
			{
			//-------------------------------------------------------------------------------------------------------------------
			public int Compare ( KeyValuePair<object, DateTime> X, 
			                     KeyValuePair<object, DateTime> Y )
				{
				//---------------------------------------------------------------------------------------------------------------
		...
		public void Add<T> ( string Name, T Value )
			...
			try
				...
				if ( this.Iso != null )
					...
					string BookmarkFile = string.Format ( "Bookmarks/{{{0}-{1}}}", DateTime.Now.ToString ( "yyyyMMdd-HHmmss" ), 
					                                                                                                  BaseName );
					//-----------------------------------------------------------------------------------------------------------
